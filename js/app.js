(() => {
    ...
    function initSliders() {
        if (document.querySelector(".tabs__slider")) {
            const tabSlider = new core(".tabs__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".tabs__arr_prev",
                    nextEl: ".tabs__arr_next"
                },
                on: {}
            });
            const showSl = document.querySelector(".categories__all");
            if (showSl) showSl.addEventListener("click", (function(e) {
                showSl.classList.add("hidden");
                const sl = document.querySelector(".tabs__slider");
                sl.classList.add("full");
                tabSlider[0].params.slidesPerView = 7;
                tabSlider[0].update();
            }));
        }
        if (document.querySelector(".layout__slider")) {
            new core(".layout__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".layout__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".layout__arr_prev",
                    nextEl: ".layout__arr_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
    ...
    document.addEventListener("click", (function(e) {
        if (isMobile.any()) {
            if (e.target.closest(".sub-menu")) e.target.closest(".sub-menu").classList.toggle("_hover");
            if (!e.target.closest(".sub-menu") && document.querySelectorAll(".sub-menu._hover").length > 0) {
                const menus = document.querySelectorAll(".sub-menu._hover");
                menus.forEach((el => {
                    el.classList.remove("_hover");
                }));
            }
            if (e.target.closest(".sub-list")) e.target.closest(".sub-list").classList.toggle("_hover");
        }
    }));
    const countInp = document.querySelector(".count-inp__input input");
    const plus = document.querySelector(".count-inp__plus");
    const minus = document.querySelector(".count-inp__minus");
    if (countInp && plus && minus) {
        plus.addEventListener("click", (function(e) {
            countInp.value = Number(countInp.value) + 1;
        }));
